...
import com.pgsoft.persistence.impl.jpa.querydsl.CategoryQueryDsl;
...
import com.pgsoft.service.impl.type.mapper.CategoryMapper;
...
@Service
public class CategoryService extends TypeServiceAdapter<Category> {
    protected CategoryService(CategoryMapper mapper
            , CategoryRepository repository
            , CategoryQueryDsl searchRepository) {
